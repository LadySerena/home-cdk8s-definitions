...
export class PrometheusOperator extends Construct {
  constructor(scope: Construct, id: string, props: PrometheusOperatorProps) {
            ...
            containers: [
              {
                ...
                resources: {
                  requests: {
                    cpu: Quantity.fromNumber(100),
                    memory: Quantity.fromNumber(100),
                  },
                  limits: {
                    cpu: Quantity.fromNumber(200),
                    memory: Quantity.fromNumber(200),
                  },
                },
                securityContext: {
    ...
    new KubeCustomResourceDefinition(this, "alertmanager-configs-crd", {
      metadata: {
        annotations: {
