...
import { KubeCustomResourceDefinition } from "../imports/k8s";

export class CertManagerCrds extends Construct {
  constructor(scope: Construct, id: string) {
    super(scope, id);
    const labels = StandardLabels("cert-manager");
    // labels["app.kubernetes.io/version"] = "v1.8.0";

    new KubeCustomResourceDefinition(this, "certificaterequests", {
      metadata: {
    ...
    new KubeCustomResourceDefinition(this, "certificates", {
      metadata: {
    ...
    new KubeCustomResourceDefinition(this, "challenges", {
      metadata: {
    ...
    new KubeCustomResourceDefinition(this, "clusterissuers", {
      metadata: {
    ...
    new KubeCustomResourceDefinition(this, "issuers", {
      metadata: {
    ...
    new KubeCustomResourceDefinition(this, "orders", {
      metadata: {
